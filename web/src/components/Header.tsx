      ...
      <D.Root>
        ...
        <D.Portal>
          ...
          <D.Content className="absolute p-10 bg-zinc-900 rounded-2xl w-full max-w-md top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            <D.Close className="absolute right-6 top-6 text-zinc-400 rounded-lg hover:text-zinc-200 transition-colors focus:outline-none focus:ring-2 focus:ring-violet-600 focus:ring-offset-2 focus:ring-offset-zinc-900">
